...
//             <p className="text-gray-600 mt-1">{entry.synopsis}</p>
//           </div>
//         </div>
...
//                 <h4 className="text-lg font-medium text-gray-900 mb-2">Not shared yet</h4>
//                 <p className="text-gray-600 mb-4">This note hasn't been shared with anyone.</p>
//                 <button
//                   onClick={() => {
